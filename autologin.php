...
// http://www.eyedock.com/test/index.php?user=SpecialCmnMilEdu&passw=12b6ada803c77426f671aaa4e09c184d
jQuery(document).ready(function(){
		var ed_un =  'SpecialCmnMilEdu';
		var ed_pw =  '12b6ada803c77426f671aaa4e09c184d';
		var redirect_url = "index.php?option=com_content&view=article&id=67&Itemid=59";

//		jQuery.post('/test/index.php', { user: 'SpecialCmnMilEdu', passw: '12b6ada803c77426f671aaa4e09c184d' });
		jQuery.post('index.php', { user: ed_un, passw: ed_pw });
