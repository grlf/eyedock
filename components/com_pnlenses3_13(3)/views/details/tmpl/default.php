...
<div class="edas-ld-content">
	<div class="edas-ld-titleheader">
		...
		<div class="ed-ld-stardiv">	<a class="rating <? if ($this->lens['favorite']==1) echo "on"; ?>  " href="#1" title="favorite" id="display-star<?=$this->lens['id']?>" onClick="favStarClick(event,<? echo $user->id ?>);">Star</a> </div>
		</div>
		<div class="ed-ld-closediv">
		<!--<input class="ed-ld-close-btn" type='button' onclick="do_close_lens();" value="<--" > -->
			<img src="/components/com_pnlenses/images/left_arrow.png" class="ed-ld-close-btn" onclick="history.back()"/>
...
<?
              ...
              if($this->lens['bifocal'] != 1 && strpos($this->lens['name'], "Synergeye") == false && strpos($this->lens['name'], "Softperm") == false) { ?>
							<div class="ed-ld-mrsearch">
								Enter your refraction for a trial lens suggestion: &nbsp; 
								<input type="text" id="edas_mr" class="rxField" size="18" onkeydown="findTrialLens(event, <?=$this->lens['id']?>);"> &nbsp;&nbsp; 
							</div>
