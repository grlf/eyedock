...
<form id='ed-lenses-searchForm'>
	<div id='name-mr-div'>
		<input type='text' class='adv-rounded defaultText deletable' id='ed-lenses-name_mr_input' onkeyup='checkRHSkeypress(event)' title='Enter a lens name or refraction' />
		<div id='more-options'><b>more filters &darr;</b></div>
