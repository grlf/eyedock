...
<form id='ed-lenses-searchForm'>
	<div id='name-mr-div'>
		<input type='text' class='adv-rounded deletable' id='ed-lenses-name_mr_input' placeholder='Enter a lens name or refraction' />
		<!-- onkeyup='checkRHSkeypress(event)' -->
		<div id='more-options'><b>more options &darr;</b></div>
	...
	<div id='adv-search-div'>
		...
		<div class='filterRow'>
			...
			<div class="clonefilter_btn" onclick="cloneClicked(event)">&nbsp;</div>
...
<!--end adv-search-div -->
<!--<div id="submitDiv" ><input type="submit" value = "Get lenses!"/></div>	-->
</form>
<button id="clearFormButton" onclick="clearAdvForm ()">clear form</button>
