...
include_once( JPATH_COMPONENT.DS.'helpers/phpClasses/RxObject.php' );
include_once( JPATH_COMPONENT.DS.'helpers/phpClasses/CLHelper.php' );
include_once( JPATH_COMPONENT.DS.'helpers/phpClasses/RxHelper.php' );
