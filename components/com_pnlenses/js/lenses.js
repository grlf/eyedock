...
var fromURL = 0; //if a search is is passed from the query string. needed for the details back button to function correctly
...
jQuery(document).ready(function(){
	...
	jQuery(window).bind("hashchange", function(e) {
		...
		if (!id > 0 && currentView == "detail") {
			currentView = "list";
			jQuery.bbq.removeState("view");
		}
	   ...
	   if (currentView == "list") {
			...
			searchData = paramObj;
		} else if (currentView == "detail" && id > 0) {
			do_display_lens(id);
