...
var searchOptionsObj = new Array(
	{name: "Even more options...", id: "none" },
...
//make another array of just the ids
var searchOptionIDs = new Array();
for (var item in searchOptionsObj){
	var obj = searchOptionsObj[item];
	searchOptionIDs.push(obj.id);
}
...
var polymers = "";
var polymer_html = function (){
	if (polymers == "" ) {
		jQuery.ajax({
			type: "POST",
			url: "/index.php?option=com_pnlenses&task=dataList&search=polymer&format=raw",
			dataType: "html",
...
var companies = "";
var company_html = function (){
	if (companies == "" ) {
		jQuery.ajax({
			type: "POST",
			url: "/index.php?option=com_pnlenses&task=dataList&search=company&format=raw",
			dataType: "html",
			success: function(result){
				companies = result;
			},
...
var sph_options = new Array("+20.00 D", "+19.00 D", "+18.00 D", "+17.00 D", "+16.00 D", "+15.00 D", "+14.00 D", "+13.00 D", "+12.00 D", "+11.00 D", "+10.00 D", "+9.00 D", "+8.00 D", "+7.00 D", "+6.00 D", "+5.00 D", "+4.00 D", "+3.00 D", "+2.00 D", "+1.00 D", "any", "-1.00 D", "-2.00 D", "-3.00 D", "-4.00 D", "-5.00 D", "-6.00 D", "-7.00 D", "-8.00 D", "-9.00 D", "-10.00 D", "-11.00 D", "-12.00 D",  "-13.00 D", "-14.00 D", "-15.00 D", "-16.00 D", "-17.00 D", "-18.00 D", "-19.00 D", "-20.00 D", "-25.00 D");
var sph_selected = 20; 
