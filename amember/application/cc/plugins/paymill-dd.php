...
jQuery(function($){
    function isSepa() {
        ...
        return reg.test($('#echeck_number').val());
    }


    $("form#echeck").submit(function(event){
        var frm = $(this);
        var params = null;
        ...
        if (isSepa()) {
            params = {
                iban: $("#echeck_number").val().replace(/\s+/g, ""),
...
class Am_Paysystem_Transaction_PaymillDd_Transaction extends Am_Paysystem_Transaction_PaymillDd_Abstract implements Am_Paysystem_Transaction_Interface
{
...
class Am_Paysystem_Transaction_PaymillDd_Refund extends Am_Paysystem_Transaction_PaymillDd_Abstract implements Am_Paysystem_Transaction_Interface
{
