...
CUT
    ...
    {
        return new Am_Controller_Echeck_SmartDebit($request, $response, $invokeArgs);
    }
    ...
    public function _doBill(Invoice $invoice, $doFirst, EcheckRecord $echeck, Am_Paysystem_Result $result)
    {
        ...
        if ($doFirst) {
            ...
            $params = array(
                ...
                'adhoc_ddi[title]' => $invoice->getLineDescription(),
...
class Am_Controller_Echeck_SmartDebit extends Am_Controller_Echeck
{
...
class Am_Paysystem_Transaction_SmartDebit_Create extends Am_Paysystem_Transaction_CreditCard
{
    ...
    {
        //skip this check to show more user friendly error message from message body
    }
