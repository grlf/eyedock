...
class Am_Paysystem_WepayOnsite extends Am_Paysystem_CreditCard
{
    ...
    {
        return new Am_Controller_CreditCard_WepayOnsite($request, $response, $invokeArgs);
    }
...
class Am_Controller_CreditCard_WepayOnsite extends Am_Controller
{
...
class Am_Paysystem_Transaction_WepayOnsite_Checkout_Get extends Am_Paysystem_Transaction_WepayOnsite
{
    ...
    public function __construct(Am_Paysystem_Abstract $plugin, Invoice $invoice, $doFirst = true, Am_Request $getrequest)
    {
