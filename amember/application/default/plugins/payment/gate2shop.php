...
class Am_Paysystem_Gate2shop extends Am_Paysystem_Abstract
{
    ...
    const LIVE_URL = "https://secure.Gate2Shop.com/ppp/purchase.do";
    const SANDBOX_URL = "https://ppp-test.safecharge.com/ppp/purchase.do";

    public function _initSetupForm(Am_Form_Setup $form)
    {
        $form->addText("merchant_id")
            ->setLabel(array('Merchant ID', 'Merchant unique identification number as provided by  Gate2Shop'));
        $form->addText("merchant_site_id")
            ->setLabel(array('Merchant Site ID', 'Merchant web site unique identification number  as provided by Gate2Shop'));
        $form->addText("secret_key", array('size' => 40))
            ->setLabel(array('Secret Key'));
