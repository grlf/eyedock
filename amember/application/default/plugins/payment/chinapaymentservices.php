...
class Am_Paysystem_Chinapaymentservices extends Am_Paysystem_Abstract
{
    ...
    {
        $form->addText('merchant_id', array('size' => 40))->setLabel(array('Your ChinaPaymentServices Merchant ID'));
        $form->addText('site_id', array('size' => 40))->setLabel(array('Your ChinaPaymentServices Site ID'));
