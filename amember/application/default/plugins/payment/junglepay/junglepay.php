...
Go to your Jungle Pay account (<a href="$acc" target"=_blank" class="link">$acc</a>) and create needed number of campaigns using this instruction here
        <a href="$instruction" target"=_blank" class="link">$instruction</a> (one aMember product - one JunglePay campaign):
