...
class Am_Paysystem_Ccbill extends Am_Paysystem_Abstract
{
    ...
    public function _initSetupForm(Am_Form_Setup $form)
    {
        ...
        $form->addText('salt')->setLabel(array('Salt', 'Contact ccBill client support and receive the salt value, OR Create your own salt value (up to 32 alphanumeric characters) and provide it to ccBill client support. '));
    }
