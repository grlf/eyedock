...
class Am_Paysystem_Netdebits extends Am_Paysystem_Abstract
{
    ...
    function init()
    {
        ...
        $this->getDi()->productTable->customFields()->add(new Am_CustomFieldSelect(self::RATES, 'CON\'s rates', '', '', array('options' => array(
                '1' => 'First CON Rate',
                '2' => 'Second CON Rate',
                '3' => 'Third CON Rate',
                '4' => 'Fourth CON Rate',
    ...
    public function _initSetupForm(Am_Form_Setup $form)
    {
        ...
        $form->addText('PID', array('size' => 20, 'maxlength' => 19))
            ->setLabel(array('PID','Everyone who operates own websites gets a PID'))
            ->addRule('required');
        $form->addText('CON', array('size' => 20, 'maxlength' => 19))
            ->setLabel(array('CON', 'Each content a.k.a. website is identified by a content id, named CON'))
            ->addRule('required');
