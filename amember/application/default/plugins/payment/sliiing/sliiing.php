...
3. Log into your Sliiing account, visit Account -> My websites and set up "Point to our script" to $rootURL/payment/sliiing/ipn
CUT
        ;
    }
...
class Am_Form_Element_SliiingBillers extends HTML_QuickForm2_Element_Input
{
    ...
    {
        return <<<CUT
            $(".option-editor-import").hide();
            $("div.options-editor table tbody.ui-sortable tr").each(function() {
                $(this).find("th:eq(1)").html('Biller Title');
                $(this).find("th:eq(2)").html('Redirect Link');
            });
CUT
        ;
    }
