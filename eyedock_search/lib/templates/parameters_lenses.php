...
<?foreach($parameters_lenses as $l){?>
  <div class="edas-tab-search-lens edas-relative" id="param-lens-<?=$l['pn_tid']?>" onclick="eyedock_lens_detail_display('<?=$l['pn_tid']?>');">
...
<?}?>
 ...
 <div class="edas-tab-search-lenses-title"><span>Lenses meeting your criterion</span></div>
