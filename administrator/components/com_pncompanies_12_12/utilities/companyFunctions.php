...
include_once  $_SERVER['DOCUMENT_ROOT'] . "/components/com_pnlenses/helpers/powerLists/formatNumberText.php";
...
function getLensParamHTMLforRow ($lens) {
	...
	if ($lens['images'] !="") {
		...
		foreach ($images as $image){
			$image = trim($image, " \s");
			$html .= "<img src='http://www.eyedock.com/modules/Lenses/pnimages/lens_images/" . $image ."' />";
		}
		$html .= "</td></tr>";
	} else {
