...
<script type="text/javascript" src="http://www.eyedock.com/administrator/components/com_pnlenses/js/lensParams.js"></script>
<!--<script type="text/javascript" src="/eyedock.com/javascript/jquery/jquery.columnmanager/jquery.columnmanager.js"></script>-->
...
<?php if($edit) { ?>
	...
	<fieldset class="adminform" style="clear:right; clear:left;">
		...
		<table class="admintable" id="powersTable" >
			...
			<?php 
				$n = count( $this->lenspowers);
				//need to show one row if this is the first time!
				if ($n ==0 ) $n = 1;
			...
			<tr size="20">
				...
				<input name="lenspowers[<?php echo $i ?>][id]" type="hidden" size="4"
				 value="<?php echo ($this->lenspowers[$i]->id == null)?"new":$this->lenspowers[$i]->id ; ?>" />
