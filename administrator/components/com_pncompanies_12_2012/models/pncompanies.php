...
class PncompaniesModelPncompanies extends JModel {
	...
	function addNewCompany($data) {
		...
		$query = 'INSERT INTO pn_lenses_companies (pn_comp_name, pn_comp_name_short, pn_logo, pn_phone, pn_address, pn_city, pn_state, pn_zip, pn_url, pn_email, pn_comp_desc, pn_contact_name, pn_contact_email, pn_hide) VALUES (
	...
	function updateCompany($data) {
		...
		pn_contact_name = "' . addslashes($data['contactName']). '",
		pn_contact_email = "' . addslashes($data['contactEmail']). '", 
		pn_hide = "' . addslashes($data['hide']) . '" where pn_comp_tid = ' . $data['id'];
