...
<?php
	JToolBarHelper::title( JText::_( 'RX Companies Administration' ), 'generic.png' );
	JToolBarHelper::deleteList();
	JToolBarHelper::editListX();
	JToolBarHelper::addNewX();
?>

<form action="index.php?option=com_rxcompanies" method="post" name="adminForm">
<table>
	<tr>
...
<div id="tablecell">
	...
	<thead>
		<tr>
			...
			<th width="4%" align="center" style="whitespace: pre-line;">Street</th>
			...
			<th width="2%" align="center" style="whitespace: pre-line;">URL</th>
	...
	for ($i=0, $n=count( $this->companies ); $i < $n; $i++)
	{
		...
		$link = JRoute::_( 'index.php?option=com_rxcompanies&view=company&task=edit&cid[]='. $row->pn_comp_id );
		$checked 	= JHTML::_('grid.id', $i, $row->pn_comp_id );
	?>
		<tr class="<?php echo "row$k"; ?>">
			...
			<td>
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'Edit Company' );?>::<?php echo htmlspecialchars($row->pn_name); ?>">
	...
	<input type="hidden" name="option" value="com_rxcompanies" />
