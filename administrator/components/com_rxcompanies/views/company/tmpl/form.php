...
<div class="col width-45">
	...
	<table class="admintable">
		<tr>
			...
			<td>
				<input class="inputbox" type="text" name="name" id="name" size="60" value="<?php echo $this->company->pn_name; ?>" />
			</td>
		</tr>
		<tr>
			<td width="110" class="key">
		...
		<tr>
			...
			<td>
				<input class="inputbox" type="text" name="street" id="street" size="60" value="<?php echo $this->company->pn_street; ?>" />
			</td>
		</tr>
		<tr>
			<td width="110" class="key">
		...
		<tr>
			...
			<td>
				<input class="inputbox" type="text" name="url" id="url" size="60" value="<?php echo $this->company->pn_url; ?>" />
			</td>
		</tr>
		<tr>
			<td width="110" class="key">
			...
			<td>
				<textarea class="inputbox" type="text" name="comments" id="comments" size="60" rows="6" cols="45"><?php echo $this->company->pn_comments; ?></textarea>
			</td>
		</tr>
	</table>
	</fieldset>
...
<div class="clr"></div>
	...
	<input type="hidden" name="id" value="<?php echo $this->company->pn_comp_id; ?>" />
